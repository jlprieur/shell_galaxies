...
C Input :
        DO J=1,NY
        READ(19,REC=J+1) (IMAGE1(I,J),I=1,NX)
        END DO
...
C Input :
        DO J=1,NY
        READ(19,REC=J+1,ERR=15) (IBUFF(I),I=1,NX)
         DO I=1,NX
          IMAGE1(I,J)=FLOAT(IBUFF(I))
         END DO
        END DO
...
C can be caused by her convention of declaring IDENT*80 :
	...
	1       ' Problems may occur when reading these files...'
        ...
        WRITE(19,REC=1)IDENT(1:NMAX),NPL,NL
          DO J=1,NY
          WRITE(19,REC=J+1) (IMAGE1(I,J),I=1,NX)
          END DO
        CLOSE(19)
        RETURN
...
C Conversion in integer*2 before output :
        DO J=1,NY
          DO I=1,NX
           ...
           IBUFF(I)=NINT(WORK)
          END DO
        WRITE(19,REC=J+1) (IBUFF(I),I=1,NX)
        END DO
