...
10	FORMAT (A)
	...
	PRINT 76
76      FORMAT(' Program Absorption  - Version of 21-09-95 -')
 
C Input of latitude and longitude :
	CALL INPUT_LOCATION(XLAT,XLONG)
 
C***** Write on a file the coordinates of the observatory:
	PRINT 3001,XLAT,XLONG
	WRITE(9,3001) XLAT,XLONG
3001	FORMAT(8x,'Latitude:',F12.6,
     1	4X,' Longitude:',F12.6)
 
C******************************************************************
C Entering the date of observation, and the equinox
	PRINT *,' Equinox ? (AAAA.AA)'
	READ(5,*) EQUIN
	PRINT *,' Day of observation? (DD,MM,YYYY) (Ex: 01 06 1988)'
	READ(5,*) IDD,MM,AA
...
C DYEARS : (year of obsevation - year of the catalogue)
C************************************************************
